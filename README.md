...
| :---: | :---: | :---: |
| EssentialsX | 可选 | 老牌经济 |
| [CY_Beibao](https://github.com/ypsdf1/CY_Beibao) | 可选 | 云背包接入 |
| [Sdf1_login](https://github.com/ypsdf1/sdf1_login) | 必选 | 债券接入，Web系统接入 |
...
## 下载地址：
[GitHub Release](https://github.com/ypsdf1/sdf1_plugn/releases) (推荐)<br>
[备用下载](https://pan.ypshidifu.cn/s/Ygc0) 提取码：sdf1
